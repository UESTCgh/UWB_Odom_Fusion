...
struct LinktrackAnchorframe0_
{
  ...
  _voltage_type voltage;
   ...
   typedef std::vector< ::nlink_parser::LinktrackTag_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::nlink_parser::LinktrackTag_<ContainerAllocator> >> _nodes_type;
  _nodes_type nodes;
  ...
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::nlink_parser::LinktrackAnchorframe0_<ContainerAllocator>& v)
  {
    ...
    for (size_t i = 0; i < v.nodes.size(); ++i)
    {
      if (false && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer< ::nlink_parser::LinktrackTag_<ContainerAllocator> >::stream(s, false ? std::string() : indent + "    ", v.nodes[i]);
    }
    if (v.nodes.empty() || false)
      s << "]";
  }
