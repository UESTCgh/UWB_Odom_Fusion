...
struct TofsenseCascade_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector< ::nlink_parser::TofsenseFrame0_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::nlink_parser::TofsenseFrame0_<ContainerAllocator> >> _nodes_type;
  _nodes_type nodes;
